...
using PhoogleZero.Localization;
using PhoogleZero.Localization.Dto;
using PhoogleZero.Migrations.Seed.Host;
using Shouldly;
using Xunit;

namespace PhoogleZero.Tests.Localization
{
    public class LanguageAppService_Tests : AppTestBase
    {
        ...
        public async Task UpdateLanguageText()
        {
            await _languageAppService.UpdateLanguageText(
                ...
                {
                    SourceName = PhoogleZeroConsts.LocalizationSourceName,
                    LanguageName = "en",
                    Key = "Save",
