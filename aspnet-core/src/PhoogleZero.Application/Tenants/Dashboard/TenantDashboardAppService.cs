...
using PhoogleZero.Tenants.Dashboard.Dto;

namespace PhoogleZero.Tenants.Dashboard
{
    [DisableAuditing]
    [AbpAuthorize(AppPermissions.Pages_Tenant_Dashboard)]
    public class TenantDashboardAppService : PhoogleZeroAppServiceBase, ITenantDashboardAppService
    {
