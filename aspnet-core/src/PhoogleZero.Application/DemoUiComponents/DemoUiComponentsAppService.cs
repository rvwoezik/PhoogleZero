...
using PhoogleZero.DemoUiComponents.Dto;

namespace PhoogleZero.DemoUiComponents
{
    [AbpAuthorize(AppPermissions.Pages_DemoUiComponents)]
    public class DemoUiComponentsAppService : PhoogleZeroAppServiceBase, IDemoUiComponentsAppService
    {
