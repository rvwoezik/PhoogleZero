...
using PhoogleZero.Authorization.Users.Profile.Cache;
using PhoogleZero.Authorization.Users.Profile.Dto;
using PhoogleZero.Friendships;
using PhoogleZero.Identity;
using PhoogleZero.Security;
using PhoogleZero.Storage;
using PhoogleZero.Timing;

namespace PhoogleZero.Authorization.Users.Profile
{
    [AbpAuthorize]
    public class ProfileAppService : PhoogleZeroAppServiceBase, IProfileAppService
    {
        ...
        public async Task<CurrentUserProfileEditDto> GetCurrentUserProfileForEdit()
        {
            ...
            userProfileEditDto.QrCodeSetupImageUrl = user.GoogleAuthenticatorKey != null
                ? _googleTwoFactorAuthenticateService.GenerateSetupCode("PhoogleZero",
        ...
        public async Task<UpdateGoogleAuthenticatorKeyOutput> UpdateGoogleAuthenticatorKey()
        {
            ...
            {
                QrCodeSetupImageUrl = _googleTwoFactorAuthenticateService.GenerateSetupCode("PhoogleZero",
                    user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300).QrCodeSetupImageUrl
            };
        }
