...
using PhoogleZero.Net.MimeTypes;
using Newtonsoft.Json;

namespace PhoogleZero.MultiTenancy.Payments.Paypal
{
    public class PayPalGatewayManager : PhoogleZeroServiceBase, IPaymentGatewayManager, ITransientDependency
    {
