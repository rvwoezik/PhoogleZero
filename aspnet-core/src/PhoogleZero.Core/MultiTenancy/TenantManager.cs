...
using PhoogleZero.MultiTenancy.Demo;
...
namespace PhoogleZero.MultiTenancy
{
    ...
    public class TenantManager : AbpTenantManager<Tenant, User>
    {
        ...
        public async Task CheckEditionAsync(int? editionId, bool isInTrialPeriod)
        {
            ...
            var error = LocalizationManager.GetSource(PhoogleZeroConsts.LocalizationSourceName).GetString("FreeEditionsCannotHaveTrialVersions");
