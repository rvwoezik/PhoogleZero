...
namespace PhoogleZero.Authentication.TwoFactor.Google
{
    public class GoogleAuthenticatorProvider : PhoogleZeroServiceBase, IUserTwoFactorTokenProvider<User>, ITransientDependency
    {
        ...
        public Task<string> GenerateAsync(string purpose, UserManager<User> userManager, User user)
        {
            ...
            var setupInfo = _googleTwoFactorAuthenticateService.GenerateSetupCode("PhoogleZero", user.EmailAddress, user.GoogleAuthenticatorKey, 300, 300);
