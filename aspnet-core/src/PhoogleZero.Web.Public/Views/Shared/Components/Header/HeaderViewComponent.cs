...
using PhoogleZero.Web.Public.Startup;
using PhoogleZero.Web.Session;

namespace PhoogleZero.Web.Public.Views.Shared.Components.Header
{
    public class HeaderViewComponent : PhoogleZeroViewComponent
    {
