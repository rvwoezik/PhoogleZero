...
namespace PhoogleZero.Web.Public.Startup
{
    [DependsOn(
        typeof(PhoogleZeroWebCoreModule)
    )]
    public class PhoogleZeroWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public PhoogleZeroWebFrontEndModule(IHostingEnvironment env, PhoogleZeroEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PhoogleZeroWebFrontEndModule).GetAssembly());
        }
    }
}
