...
using PhoogleZero.Web.Authentication.JwtBearer;
using PhoogleZero.Web.Authentication.TwoFactor;
using PhoogleZero.Web.Configuration;
#if FEATURE_SIGNALR
using Abp.Web.SignalR;
#endif

namespace PhoogleZero.Web
{
    [DependsOn(
    ...
    public class PhoogleZeroWebCoreModule : AbpModule
    {
        private readonly IHostingEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public PhoogleZeroWebCoreModule(IHostingEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(PhoogleZeroApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(PhoogleZeroWebCoreModule).GetAssembly());
        }
        ...
        private void SetAppFolders()
        {
            ...
            {
                var currentAssemblyDirectoryPath = typeof(PhoogleZeroWebCoreModule).GetAssembly().GetDirectoryPathOrNull();
