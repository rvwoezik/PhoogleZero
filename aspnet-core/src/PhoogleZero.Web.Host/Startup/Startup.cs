...
using PhoogleZero.Web.IdentityServer;

#if FEATURE_SIGNALR
using PhoogleZero.Web.Owin;
using Abp.Owin;
...
namespace PhoogleZero.Web.Startup
{
    public class Startup
    {
        ...
        public IServiceProvider ConfigureServices(IServiceCollection services)
        {
            ...
            {
                options.SwaggerDoc("v1", new Info { Title = "PhoogleZero API", Version = "v1" });
            ...
            return services.AddAbp<PhoogleZeroWebHostModule>(options =>
            {
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ILoggerFactory loggerFactory)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "PhoogleZero API V1");
            }); //URL: /swagger
        }
        ...
        private static void ConfigureOwinServices(IAppBuilder app)
        {
            ...
            app.Properties["host.AppName"] = "PhoogleZero";
